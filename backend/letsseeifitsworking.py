...
# Step 3: Run the downloader with your gallery URL
# Replace this URL with your actual gallery URL
gallery_url = "https://imx.to/g/1focb"

# Run the downloader
download_gallery(
    gallery_url=gallery_url,
    output_dir="/workspaces/imxtoscrpaer/backend/downloaded_images1",
    delay=1.5,
    resume=False,
